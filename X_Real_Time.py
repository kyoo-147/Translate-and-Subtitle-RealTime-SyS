...
# File realtime translate language
...
from X_Real_Time_GUI import TranscriptionWindow
...
def main():
    ...
    parser.add_argument("--translation_lang", default='Vietnamese',
